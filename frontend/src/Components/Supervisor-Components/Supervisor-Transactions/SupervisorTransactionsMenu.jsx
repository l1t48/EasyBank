...
import SupervisorTransactionsFilteringOptions from './SupervisorTransactionsFilteringOptions';
import { SUPERVISOR_TRANSACTIONS_MENU } from '../../../Data/Global_variables';

export default function Transaction_menu_supervisor({ activeFilters, setActiveFilters }) {
    ...
    return (
        <div className="w-full flex flex-col items-stretch px-4 sm:px-6 lg:px-8">
            ...
            <SupervisorTransactionsFilteringOptions
