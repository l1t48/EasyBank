...
function AdminAuditLogsFilteringOptions({ isOpen, onClose, onApplyFilters }) {
      ...
      >
        ...
        <form onSubmit={handleApplyFilters} className="p-4 overflow-y-auto" style={{ flex: 1 }}>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
            <div>
              <label htmlFor="AdminFilterOptionsLogAccountNumber" className="block text-[var(--nav-text)] text-sm mb-1">Account Number</label>
              <input
                type="text"
                id="AdminFilterOptionsLogAccountNumber"
            ...
            <div>
              <label htmlFor="AdminFilterOptionsLogRole" className="block text-[var(--nav-text)] text-sm mb-1">Role</label>
              <select
                value={role}
                id="AdminFilterOptionsLogRole"
            ...
            <div>
              <label htmlFor="AdminFilterOptionsLogFromDate" className="block text-[var(--nav-text)] text-sm mb-1">From Date</label>
              <input
                type="date"
                id="AdminFilterOptionsLogFromDate"
                value={startDate}
            ...
            <div>
              <label htmlFor="AdminFilterOptionsToDate" className="block text-[var(--nav-text)] text-sm mb-1">To Date</label>
              <input
                type="date"
                id="AdminFilterOptionsToDate"
                value={endDate}
            ...
            <div>
              <label htmlFor="AdminFilterOptionsLimit" className="block text-[var(--nav-text)] text-sm mb-1">Limit</label>
              <select
                value={limit}
                id="AdminFilterOptionsLimit"
...
export default AdminAuditLogsFilteringOptions;
