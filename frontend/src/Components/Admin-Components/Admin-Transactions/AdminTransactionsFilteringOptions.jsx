        ...
        <form onSubmit={handleApplyFilters} className="p-4 overflow-y-auto" style={{ flex: 1 }}>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
            ...
            <div className="col-span-1 lg:col-span-1">
              <label htmlFor="FilterOptionsAdminTransactionID" className="block text-[var(--nav-text)] text-sm mb-1">Transaction ID (Optional)</label>
              <input
                type="text"
                id="FilterOptionsAdminTransactionID"
                placeholder="e.g., TXN-"
                value={transactionId}
            ...
            <div className="col-span-1 lg:col-span-1">
              <label htmlFor="FilterOptionsAdminAccountNumber" className="block text-[var(--nav-text)] text-sm mb-1">Account Number (Optional)</label>
              <input
                type="text"
                id="FilterOptionsAdminAccountNumber"
            ...
            <div>
              <label htmlFor="FilterOptionsAdminStatus" className="block text-[var(--nav-text)] text-sm mb-1">Status</label>
              <select
                id="FilterOptionsAdminStatus"
                value={status}
            ...
            <div>
              <label htmlFor="FilterOptionsAdminType" className="block text-[var(--nav-text)] text-sm mb-1">Type</label>
              <select
                value={type}
                id="FilterOptionsAdminType"
            ...
            <fieldset className="col-span-1 sm:col-span-2 lg:col-span-2 border border-[var(--nav-text)] p-3 rounded-md">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-2">
                <div>
                  <label htmlFor="FilterOptionsAdminFromDate" className="text-[var(--nav-text)] text-sm block mb-1">From Date</label>
                  <input
                    type="date"
                    id="FilterOptionsAdminFromDate"
                    value={startDate}
                ...
                <div>
                  <label htmlFor="FilterOptionsAdminToDate" className="text-[var(--nav-text)] text-sm block mb-1">To Date</label>
                  <input
                    type="date"
                    id="FilterOptionsAdminToDate"
                    value={endDate}
            ...
            <fieldset className="col-span-1 sm:col-span-2 lg:col-span-1 border border-[var(--nav-text)] p-3 rounded-md">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-2">
                <div>
                  <label htmlFor="FilterOptionsAdminMinAmount" className="text-[var(--nav-text)] text-sm block mb-1">Min Amount</label>
                  <input
                    type="number"
                    id="FilterOptionsAdminMinAmount"
                    placeholder="Min"
                    value={minAmount}
                ...
                <div>
                  <label htmlFor="FilterOptionsAdminMaxAmount" className="text-[var(--nav-text)] text-sm block mb-1">Max Amount</label>
                  <input
                    id="FilterOptionsAdminMaxAmount"
                    type="number"
                    placeholder="Max"
                    value={maxAmount}
