        ...
        {isActionable ? (
          <>
            <button
              ...
              className={`px-3 py-1 text-xs font-bold rounded border border-[--bg] ${loadingRow.approve ? "opacity-60 cursor-wait" : "bg-[var(--nav-text)] text-[var(--nav-bg)] hover:text-[var(--nav-text)] hover:bg-[var(--nav-bg)] duration-300 transition-colors"}`}
            >
            ...
            <button
              ...
              disabled={loadingRow.approve || loadingRow.reject}
              className={`px-3 py-1 text-xs font-bold rounded border ${loadingRow.reject ? "opacity-60 cursor-wait" : "border-[var(--danger-border)] bg-[var(--nav-text)] text-[var(--nav-bg)] hover:bg-[var(--danger-hover-bg)] duration-300 transition-colors"}`}
            >
...
export default AdminAllTransactionsMobileCards;